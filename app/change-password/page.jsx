    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mb-4">
            <label htmlFor="currentPassword" className="block text-sm font-medium mb-2 text-zinc-700">
              Current Password
            </label>
            <input
              type="password"
          ...
          <div className="mb-4">
            <label htmlFor="newPassword" className="block text-sm font-medium mb-2 text-zinc-700">
              New Password
            </label>
            <input
              type="password"
